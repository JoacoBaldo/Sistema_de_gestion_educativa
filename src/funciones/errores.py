...
EMAIL_NO_EXISTE = {"error": "El email ingresado no esta en la base de datos", "status": 404}
...
DATOS_EVALUACION_REQUERIDOS = {"error": "classroom_id, fecha y aulas son requeridos", "status": 400}
