...
from src.funciones.errores import EMAIL_NO_EXISTE, EMAIL_NO_VALIDO, EMAIL_YA_EXISTE, CONTRASENA_DEBIL
...
def change_password_mail(email: str) -> dict:
    ...
    return {"message": "Enviamos el mail con las instrucciones para cambiar la contraseña.", "status_code": 200}
